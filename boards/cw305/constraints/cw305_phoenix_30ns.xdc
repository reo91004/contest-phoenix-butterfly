...
# USB interface stays at 100 MHz. PHOENIX crypto clock is constrained for the
# 30 ns baseline; host software must configure/provide the matching clock.
create_clock -period 10.000 -name usb_clk -waveform {0.000 5.000} [get_nets usb_clk]
create_clock -period 30.000 -name tio_clkin -waveform {0.000 15.000} [get_nets tio_clkin]
create_clock -period 30.000 -name pll_clk1 -waveform {0.000 15.000} [get_nets pll_clk1]
